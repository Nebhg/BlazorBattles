...
namespace BlazorBattles.Server.Controllers
{
    ...
    public class UnitController : ControllerBase
    {
        ...
        [HttpDelete("{id}")] //Add a route to delete method with the id 
